...
void CAN_Transmit(void)
{
    ...
    hcan1.pTxMsg->Data[0] = (uint8_t)(((uint32_t)((TCC1.P * 256.f)) & 0x00ff) >> 0); //Òåìïåðàòóðà
    hcan1.pTxMsg->Data[1] = (uint8_t)(((uint32_t)((TCC1.P * 256.f)) & 0xff00) >> 8); //Òåìïåðàòóðà

    hcan1.pTxMsg->Data[2] = (uint8_t)(((uint32_t)((TCC2.P * 256.f)) & 0x00ff) >> 0); //Òåìïåðàòóðà
    hcan1.pTxMsg->Data[3] = (uint8_t)(((uint32_t)((TCC2.P * 256.f)) & 0xff00) >> 8); //Òåìïåðàòóðà

    hcan1.pTxMsg->Data[4] = (uint8_t)(((uint32_t)((TCC3.P * 256.f)) & 0x00ff) >> 0); //Òåìïåðàòóðà
    hcan1.pTxMsg->Data[5] = (uint8_t)(((uint32_t)((TCC3.P * 256.f)) & 0xff00) >> 8); //Òåìïåðàòóðà

    hcan1.pTxMsg->Data[6] = (uint8_t)(((uint32_t)((TCC4.P * 256.f)) & 0x00ff) >> 0); //Òåìïåðàòóðà
    hcan1.pTxMsg->Data[7] = (uint8_t)(((uint32_t)((TCC4.P * 256.f)) & 0xff00) >> 8); //Òåìïåðàòóðà
...
void HAL_CAN_RxCpltCallback(CAN_HandleTypeDef* CanHandle)
{
    ...
    if (hcan1.pRxMsg->StdId == 0x2F) {
        _dataL = hcan1.pRxMsg->Data[3] << 24 | hcan1.pRxMsg->Data[2] << 16 | hcan1.pRxMsg->Data[1] << 8 | hcan1.pRxMsg->Data[0] << 0;
        _dataH = hcan1.pRxMsg->Data[7] << 24 | hcan1.pRxMsg->Data[6] << 16 | hcan1.pRxMsg->Data[5] << 8 | hcan1.pRxMsg->Data[4] << 0;
  }
