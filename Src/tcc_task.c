...
void Sensor_1_Task(void) { 
  ...
  while (Timer_100_ms > 0) {
    ...
    I_1_IN_M = (Mediana_filter16(Median_mass_I_1_IN_M, 10)) * Uverif / 4095.f;
    U_1_IN_M = (Mediana_filter16(Median_mass_U_1_IN_M, 10)) * Uverif / 4095.f;
    U_1_OUT_M = (Mediana_filter16(Median_mass_U_1_OUT_M, 10)) * Uverif / 4095.f;
    taskYIELD();
  }
...
void Sensor_2_Task(void) {
  ...
  while (Timer_100_ms > 0) {
    ...
    U_2_OUT_M = (Mediana_filter16(Median_mass_U_2_OUT_M, 10)) * Uverif / 4095;
    taskYIELD();
  }
...
void Sensor_3_Task(void) {
  ...
  while (Timer_100_ms > 0) {
    ...
    U_3_OUT_M = (Mediana_filter16(Median_mass_U_3_OUT_M, 10)) * Uverif / 4095;
    taskYIELD();
  }
...
void Sensor_4_Task(void) {
  ...
  while (Timer_100_ms > 0) {
    ...
    U_4_OUT_M = (Mediana_filter16(Median_mass_U_4_OUT_M, 10)) * Uverif / 4095;
    taskYIELD();
  }
